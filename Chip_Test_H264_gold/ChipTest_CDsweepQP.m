...
% reference frame (JPEG-decoded). Bitstream should be sent out through AHB
% debugging path. 

% Change Quant to make this script a range of QPs or just testing one QP
...
Compres_ratio_IMGvsIMG = zeros(1, length(Quant));
