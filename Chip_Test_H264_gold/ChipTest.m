...
global bw_pixel; bw_pixel = 8;
global QP;
% Set Quantization Parameter here
Quant = (0+(bw_pixel-8)*4):(52+(bw_pixel-8)*4);

%filename = './../03_captures/isp2/tb_23_0610_1352.bin_raw';QP = Quant(10);
filename = './../03_captures/isp2/tb_24_0613_1406.bin_raw';QP = Quant(20);
...
SetTable
idx = 1;
[Dec_Y_cd,Dec_U_cd, Dec_V_cd, idx, dbgbuf] = DEC_Frame2(idx,bitstream,ref_frame,cd_map);
