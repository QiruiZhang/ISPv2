...
# input is at addr 0
# these do not need to change per input chunk
layer2_unified_huff_base_addr_128 = int(8192)
layer2_unified_bias_base_addr_128 = int(9216)
layer2_unified_w_base_addr_128    = int(10240)
...
fc1_base_w_addr_512 = int(3584)
fc1_base_b_addr_128 = int(22528)

fc2_base_w_addr_512 = int(6144)
fc2_base_b_addr_128 = int(28672)
