...
fc1_w_load = np.load("weight_files/fc1w.npy")
fc1_b = np.load("weight_files/fc1b.npy")
fc2_w_load = np.load("weight_files/fc2w.npy")
fc2_b = np.load("weight_files/fc2b.npy")
