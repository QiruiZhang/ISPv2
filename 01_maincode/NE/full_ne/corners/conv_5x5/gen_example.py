...
layer1_unified_huff_base_addr_128 = int(4096)
layer1_unified_bias_base_addr_128 = int(5120)
layer1_unified_w_base_addr_128    = int(6144)
...
print("conv1 weights start at 0x%x" % cwaddr)
for i in range(0, len(layer1_CWRAM_word_list_full)):
    ...
    cwaddr += 1
print("conv1 weights END at 0x%x" % cwaddr)
...
print("huff w start: 0x%x" % layer1_unified_huff_base_addr_128)
...
print("huff w end / huff loc start: 0x%x" % huffaddr)
...
print("huff loc end: 0x%x" % huffaddr)
...
print("Bias start addr: 0x%x" % layer1_unified_bias_base_addr_128)
...
print("Bias end addr: 0x%x" % biaddr)
