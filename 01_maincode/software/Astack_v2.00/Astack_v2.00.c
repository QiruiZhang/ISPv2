...
volatile cmpv1_r0B_t prev17_r0B = CMPv1_R0B_DEFAULT;
...
void handler_ext_int_spi0     (void) __attribute__ ((interrupt ("IRQ")));
void handler_ext_int_spi1     (void) __attribute__ ((interrupt ("IRQ")));
void handler_ext_int_spi2     (void) __attribute__ ((interrupt ("IRQ")));
void handler_ext_int_spi3     (void) __attribute__ ((interrupt ("IRQ")));
void handler_ext_int_sbpg     (void) __attribute__ ((interrupt ("IRQ")));
void handler_ext_int_mau      (void) __attribute__ ((interrupt ("IRQ")));
void handler_ext_int_cantx    (void) __attribute__ ((interrupt ("IRQ")));
void handler_ext_int_canrx    (void) __attribute__ ((interrupt ("IRQ")));
void handler_ext_int_canerr   (void) __attribute__ ((interrupt ("IRQ")));
...
void handler_ext_int_spi0     (void){ *NVIC_ICPR = (0x1 << 19);}
void handler_ext_int_spi1     (void){ *NVIC_ICPR = (0x1 << 20);}
void handler_ext_int_spi2     (void){ *NVIC_ICPR = (0x1 << 21);}
void handler_ext_int_spi3     (void){ *NVIC_ICPR = (0x1 << 22);}
void handler_ext_int_sbpg     (void){ *NVIC_ICPR = (0x1 << 23);}
void handler_ext_int_mau      (void){ *NVIC_ICPR = (0x1 << 24);}
void handler_ext_int_cantx    (void){ *NVIC_ICPR = (0x1 << 25);}
void handler_ext_int_canrx    (void){ *NVIC_ICPR = (0x1 << 26);}
void handler_ext_int_canerr   (void){ *NVIC_ICPR = (0x1 << 27);}
